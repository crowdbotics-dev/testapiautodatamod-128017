...
## Project Structure
    ...
    ├── testapiautodatamod_128017  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_128017`
...
2. Clone this repo and `cd testapiautodatamod_128017`
